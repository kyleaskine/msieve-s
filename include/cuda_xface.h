...
/* CUDA error checking macro.
   On error, prints diagnostic info and exits via exit(-1).
   Note: exit() (not _exit()) ensures atexit() handlers run,
   which will perform emergency GPU cleanup to prevent resource leaks */
